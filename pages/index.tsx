              ...
              >
                ...
                <div className="card h-80 shadow-light-lg mb-6 mb-md-0 lift lift-lg">
                  ...
                  <div className="card-body position-relative">
                    ...
                    <p className="text-muted">
                      Bring a full body fitness training routine to your living
                      room.
                    </p>
                    {/* Link */}
                    <a
              ...
              >
                ...
                <div className="card h-80 shadow-light-lg mb-6 mb-md-0 lift lift-lg">
                  ...
                  <div className="card-body position-relative">
                    ...
                    <a
                      target="_blank"
                      href="https://on.superfitapp.com/s/603dbrFWGk5V2bZYHm0W"
                      className="fw-bold text-decoration-none"
                    >
                      View Schedule <i className="fe fe-arrow-right ms-3" />
                    </a>
          ...
          <div className="container">
            <div className="row align-items-center justify-content-between">
              <div className="col-12 col-md-6 col-lg-5">
                ...
                >
                  <span className="h6 text-uppercase fw-bold">Learn More</span>
                </a>
                {/* </Link> */}
              </div>
                        ...
                        >
                          <div className="py-5 py-mb-6">
                            <p>
                              ...
                              and clients into one workout "schedule" for free.{" "}
                              <br />
                              <br />
                              ...
                              users can view, start, or copy and "remix" public
                              workouts.
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          <div className="py-5 py-md-6">
                            <p>
                              ...
                              but a free account allows us to save your workout
                              completions.
                            </p>
                            <a
                              target="_blank"
