                    ...
                    <div className="col-12 col-md-6">
                      ...
                      >
                        ...
                        <a
                          ...
                          style={{
                            backgroundImage:
                              "url(assets/img/photos/photo-26.jpg)",
                          }}
                          href="#!"
                        >
                          {/* Image (placeholder) */}
                      ...
                      >
                        <div className="w-100">
                          ...
                          <a className="card-body" href="#!">
                            ...
                            <p className="mb-0 text-muted">
                              Lorem ipsum dolor sit amet, consectetur adipiscing
                              elit. Duis nec condimentum quam. Fusce
                              pellentesque faucibus lorem at viverra. Integer at
                              feugiat odio. In placerat euismod risus proin erat
                              purus.
                            </p>
                          </a>
                          {/* Meta */}
